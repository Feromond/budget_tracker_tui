...
pub fn get_help_for_mode(mode: AppMode) -> Vec<KeyBindingInfo> {
    match mode {
        AppMode::Normal => vec![
            ...
            KeyBindingInfo::new("b", "Budget View", "Actions", Some("View monthly budget progress and budgeted category spending for the selected month.")),
        ...
        AppMode::Settings => vec![
            ...
            KeyBindingInfo::new("Database Path", "SQLite Database Location", "Fields", Some("Path to the SQLite database that stores category and subcategory data. Point this at a new file to create a fresh database, or an existing file to load a different category catalog.")),
            KeyBindingInfo::new("Manage Categories", "Open Category Catalog", "Fields", Some("Select this action and press Enter to open the category catalog manager.")),
            ...
            KeyBindingInfo::new("Hide Help Bar", "Toggle Help Bar", "Fields", Some("Toggle to hide the bottom help bar for a cleaner interface. Ctrl+H will still work. NOT RECOMMENDED unless you know the keybindings well.")),
            ...
            KeyBindingInfo::new("Enter", "Save Settings / Activate Action", "Actions", None),
